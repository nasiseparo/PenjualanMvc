									...
									<c:forEach items="${barang}" var="b">
										<tr>
											...
											<td><a class="btn btn-warning"
												href="${pageContext.request.contextPath}/barang/edit/${b.kodeBarang}">edit</a>&nbsp
												<a class="btn btn-danger" href="${pageContext.request.contextPath}/barang/delete/${b.kodeBarang}">Delete</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
