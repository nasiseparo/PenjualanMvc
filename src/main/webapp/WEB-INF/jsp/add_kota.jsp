...
<body>
	...
	<div class="container container-fluid">
		<form:form method="POST"
			action="${pageContext.request.contextPath}/kota/save"
			modelAttribute="dto">
			...
			<div class="form-group">
				...
				<form:input class="form-control" placeholder="Masukkan Nama Kota"
					path="namaKota" />
				<form:errors path="namaKota" />
			</div>
			<div class="form-group">
				<label for="exampleInputPassword1">Kode Provinsi</label>
				<form:input class="form-control" placeholder="Masukkan Kode Provinsi"
					path="kodeProvinsi" />
				<form:errors path="kodeProvinsi" />
			</div>
